...
import { yearBuiltData } from "../data/addToUserData";
        ...
        <div className="m-w-1/2 space-y-8">
          <div>
            ...
            <div className="flex items-center justify-center pt-4">
              ...
              <p className="pl-2 text-gray-400">Estimates are okay!</p>
            </div>
          </div>
          <form className="mt-8 space-y-6">
            <div className=" space-y-6 flex flex-col  items-center justify-center">
              ...
              <button className="underline text-gray-500 decoration-gray-500 " onClick={notSure}> I'm Not Sure</button>
              <button
                type="submit"
