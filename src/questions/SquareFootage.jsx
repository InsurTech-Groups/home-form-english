...
import { squareFootageData } from "../data/addToUserData";
      ...
      <div className="m-w-1/2 space-y-8">
        <div>
            ...
            <svg
              ...
              <p className="pl-2 text-gray-400">Minimum is 100 sqft</p>
        </div>
        </div>
        ...
        <div className=" space-y-6 flex flex-col  items-center justify-center">
            ...
            className={`px-6 py-4 max-w-xl w-full  mt-5 text-lg bg-pink-600 ${isButtonDisabled ? 'cursor-not-allowed disabled:opacity-75  bg-input-purple' : ""} hover:shadow-lg text-white rounded transition duration-200`}
            id="zipCodeButton"
            onClick={nextStep}>
            Next
          </button>
